...
| 04-06-03 | 06 | 4 | NOTIF-02, NOTIF-06 | T-04-40 / T-04-42 | Ordering asserted as a sequence; no hand-rolled sleep and no two-command claim in either new service tree; no payload in any log call; both consumer groups manual-commit | unit | `uv run pytest tests/unit/test_idempotency_ordering.py tests/unit/test_no_inline_sleep.py tests/unit/test_no_setnx_expire_pairs.py tests/unit/test_kafka_consumer_config.py tests/unit/test_logs_never_carry_payload.py -q -W error::RuntimeWarning` | ❌ W0 (task creates `test_idempotency_ordering.py`; extends four existing gates) | ⬜ pending |
